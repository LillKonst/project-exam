  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative w-full h-[70vh]">
        ...
        />
        <button type="button" onClick={openGallery} className="bg-yellow-300 font-semibold text-xl px-4 py-3 absolute top-1 right-1 m-1 rounded-md flex items-center">
          GALLERY 
      ...
      <div className="flex flex-col -mt-12 mx-12 w-10/12 z-10 p-5 relative bg-white shadow-md rounded-md ">
        <div className="flex m-8 mb-5 border-b">
          <div className="flex flex-col">
            <div className="flex flex-row">
              <h2 className="text-3xl ms-1">{venue.name}</h2>
              {/* <div>
              {[...Array(5)].map((_, i) => (              <img key={i} src={i < review.rating ? starFilled : starNotFilled} alt="rating star" />            ))}
              </div> */}
        ...
        <div className="flex ms-auto m-2">
            <p className="text-2xl me-1">${venue.price}</p>
            <p className="text-2xl text-gray-600">night</p>
        ...
        <div className="flex flex-row">
          ...
          {venue.meta.pets ? (
          <p className="text-sm flex"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="16" height="16" className="me-2"><path d="M226.5 92.9c14.3 42.9-.3 86.2-32.6 96.8s-70.1-15.6-84.4-58.5s.3-86.2 32.6-96.8s70.1 15.6 84.4 58.5zM100.4 198.6c18.9 32.4 14.3 70.1-10.2 84.1s-59.7-.9-78.5-33.3S-2.7 179.3 21.8 165.3s59.7 .9 78.5 33.3zM69.2 401.2C121.6 259.9 214.7 224 256 224s134.4 35.9 186.8 177.2c3.6 9.7 5.2 20.1 5.2 30.5l0 1.6c0 25.8-20.9 46.7-46.7 46.7c-11.5 0-22.9-1.4-34-4.2l-88-22c-15.3-3.8-31.3-3.8-46.6 0l-88 22c-11.1 2.8-22.5 4.2-34 4.2C84.9 480 64 459.1 64 433.3l0-1.6c0-10.4 1.6-20.8 5.2-30.5zM421.8 282.7c-24.5-14-29.1-51.7-10.2-84.1s54-47.3 78.5-33.3s29.1 51.7 10.2 84.1s-54 47.3-78.5 33.3zM310.1 189.7c-32.3-10.6-46.9-53.9-32.6-96.8s52.1-69.1 84.4-58.5s46.9 53.9 32.6 96.8s-52.1 69.1-84.4 58.5z"/></svg> Pets allowed</p>
          ) : (
