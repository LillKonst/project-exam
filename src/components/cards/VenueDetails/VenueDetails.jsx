  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col -mt-12 mx-12 w-10/12 z-10 p-5 bg-white shadow-md rounded-md ">
        <div className="flex m-8 mb-5 pb-5 border-b">
          <div className="flex flex-col">
            <div className="flex flex-row">
              ...
              {[...Array(venue.rating)].map((_, i) => (
                 ...
                 height="16" 
                 fill="currentColor"
                 className="bi bi-star ms-1 mt-1" 
                 viewBox="0 0 16 16"
               >
        ...
        <div className="flex flex-col items-center ms-auto m-2">
          ...
          <p className="text-sm m-1 ">Max Guests: {venue.maxGuests}</p>
        </div>
      </div>
