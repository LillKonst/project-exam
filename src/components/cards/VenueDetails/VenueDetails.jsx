  ...
  return (
    <div>
      <div className="relative w-full h-[70vh]">
        ...
        />
        <button type="" className="bg-white p-2 absolute top-0 right-0 m-1 rounded-md">GALLERY</button>
      </div>
            
      <div className="flex flex-col -mt-12 mx-10 z-10 relative bg-white shadow-md rounded-md ">
        <div className="relative m-5 mb-5">
          <div className="flex flex-row">
            <h2 className="text-2xl ms-1">{venue.name}</h2>
