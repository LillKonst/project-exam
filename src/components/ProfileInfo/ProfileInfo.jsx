    ...
    <div className="flex w-3/4 relative p-3 m-1 md:m-3">
      ...
      <div className="mt-5 mx-3">
        <div className="flex items-end">
          ...
          {isVenueManager && (
            <h2 className="text-xl font-semibold ms-2 text-gray-700">
              • VENUE MANAGER
            </h2>
          )}

          <button
            className="font-semibold text-sm self-center hover:bg-hoverRed text-customWhite bg-customRed ms-12 px-3 py-2 rounded flex items-center gap-2"
